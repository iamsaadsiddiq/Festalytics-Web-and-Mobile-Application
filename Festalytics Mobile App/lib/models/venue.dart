...
class Venue {
  ...
  factory Venue.fromFirestore(String docId, Map<String, dynamic> data) => Venue(
        ...
        faqs: data['faqs'] ?? [],
        images: data['images'] ?? [],
        blockedDates: (data['blockedDates'] as List?)?.map((e) => e.toString()).toList() ?? [],
        blackoutDates: (data['blackoutDates'] as List?)?.map((e) => e.toString()).toList() ?? [],
        bookedDates: (data['bookedDates'] as List?)?.map((e) => e.toString()).toList() ?? [],
